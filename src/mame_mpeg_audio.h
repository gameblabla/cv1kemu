...
/***************************************************************************
    ...
    Standalone copy adapted from MAME src/devices/sound/mpeg_audio.*
...
public:
	...
	cv1k_mame_mpeg_audio(const void *base, unsigned int accepted, bool lsb_first, int position_align);
